...
class report_account_common_zateg(report_account_common):

    def __init__(self, cr, uid, name, context=None):
        super(report_account_common_zateg, self).__init__(cr, uid, name, context=context)
        self.localcontext.update( {
            'get_lines': self.get_lines_zateg,
        })
        self.context = context

    def get_lines_zateg(self, data):
        lines = []
            ...
            if account_ids:
                for account in account_obj.browse(self.cr, self.uid, account_ids, context=data['form']['used_context']):
                    ...
                    vals = {
                        ...
                        'foreign_balance':  account.foreign_balance != 0 and account.foreign_balance * report.sign or account.foreign_balance,
