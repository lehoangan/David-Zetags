...
class accounting_report(osv.osv_memory):
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        data['form'].update(self.read(cr, uid, ids,
                                      ['currency', 'partner_id', 'date_from_cmp', 'debit_credit', 'date_to_cmp',
                                       'fiscalyear_id_cmp', 'period_from_cmp', 'period_to_cmp', 'filter_cmp',
                                       'account_report_id', 'enable_filter', 'label_filter', 'target_move', 'currency'],
                                      context=context)[0])
        return {
...
class account_balance_report(osv.osv_memory):
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        ...
        data['form'].update(
            self.read(cr, uid, ids, ['currency', 'partner_id', 'account_filter', 'account_filter_id'], context=context)[
                0])
