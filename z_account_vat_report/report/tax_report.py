        ...
        for type in [('out_invoice', 'out_refund'),('in_invoice', 'in_refund')]:
            ...
            for invoice in invoice_obj.browse(cr, uid, invoice_ids):
                ...
                for tax in invoice.tax_line:
                    amount = (tax.base + tax.amount) * rate
                ...
                for tax in invoice.tax_line:
                    if tax.name == tax_name:
                        result += [{
                            ...
                            'detail': ','.join(details),
                            'tax': tax_name or '',
                            'sale': type == ('out_invoice', 'out_refund') and tax.base + tax.amount or '',
                            'tax_sale': type == ('out_invoice', 'out_refund') and tax.amount or '',
                            'purchase': type != ('out_invoice', 'out_refund') and tax.base + tax.amount or '',
